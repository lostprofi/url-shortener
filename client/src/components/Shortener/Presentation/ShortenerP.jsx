...
const ShortenerP = ({ onChange }) => {
  ...
  return (
    <form className={fullURLFormCls.form} noValidate>
      <Grid container spacing={3}>
        <Grid item xs={8}>
          <TextField id="fullURL" onChange={onChange} label="Shorten your link" variant="outlined" className={fullURLFormCls.input} />
        </Grid>
        <Grid item xs={4}>
